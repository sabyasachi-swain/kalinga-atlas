...
- **Before committing pass 1 and the restyle:** confirm the -v3 screenshots at 1280 and 380 px, overlap counts of 0, 2 or fewer renders per 20-step zoom, and passing check and build.
